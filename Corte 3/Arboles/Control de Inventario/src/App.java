...
que use contarHojas() e imprima un mensaje indicando cuántos repuestos no tienen variantes relacionadas en el catálogo.
*/
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        ArbolRepuestos inventario = new ArbolRepuestos();
